...
public class Volley {
     ...
     */
    public static RequestQueue newRequestQueue(Context context, HttpStack stack, boolean selfSignedCertificate, InputStream inputStream) {
        ...
        if (stack == null) {
            if (Build.VERSION.SDK_INT >= 9) {
                if (selfSignedCertificate && inputStream != null) {
                    stack = new HurlStack(null,
                            buildSSLSocketFactory(context, inputStream));
                }
                else {
                    stack = new HurlStack();
                }
                ...
                if (selfSignedCertificate) {
                    stack = new HttpClientStack(
                            getHttpClient(context, inputStream));
                }
                else {
                    stack = new HttpClientStack(
    ...
    private static SSLSocketFactory buildSSLSocketFactory(Context context, InputStream inputStream) {
    ...
    private static HttpClient getHttpClient(Context context, InputStream inputStream) {
        KeyStore keyStore = null;
        try {
            keyStore = buildKeyStore(context, inputStream);
        } catch (KeyStoreException e) {
    ...
    private static Certificate readCert(Context context, InputStream inputStream) {
        ...
        //                                 .openRawResource(certResourceID);
        Certificate ca = null;
